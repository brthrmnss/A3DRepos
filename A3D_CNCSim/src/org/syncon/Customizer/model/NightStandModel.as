package org.syncon.Customizer.model
{
	...
	public class NightStandModel extends Actor 
	{
		...
		*/
		 ...
		 * Stores meshes we are working with ? 
		 * */
		private var _behaviors : BehaviorVO = new BehaviorVO(); 
		public function get behaviors(): BehaviorVO
		{
			return _behaviors;
		}
		
		public function set behaviors(value:BehaviorVO):void
		{
			_behaviors = value;
			this.dispatch( new NightStandModelEvent( NightStandModelEvent.BEHAVIORS_CHANGED, value ) ) 
		}
		
		private var _plan : PlanVO = new PlanVO(); 
